...
class Config(object):
    ...
    ASTEC_TYPE = os.getenv('ASTEC_TYPE', r"linux_64")  # Assuming ASTEC_TYPE is the correct variable
    
    BACKUP_DIRECTORY = os.getenv('BACKUP_DIRECTORY', r"Z:\\scc\\projects\\ASSAS\\backup_mongodb")
