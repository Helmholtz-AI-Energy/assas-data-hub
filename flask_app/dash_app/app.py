    ...
    dbc.Container(
        [
            html.A(
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            html.Img(
                                src=encode_svg_image("assas_logo_mod.svg"),
                                height="60px",
                                width="120px",
                        ...
                        dbc.Col(
                            html.Img(
                                src=encode_svg_image("kit_logo.drawio.svg"),
                                height="60px",
                                width="120px",
                                style={"border": "1px grey solid"},
                            ),
                        ...
                        dbc.Col(
                            dbc.NavbarBrand("ASSAS Data Hub", className="ms-2"), width=3
                        ),
                    ],
                    align="center",
                    className="g-0",
            ...
            dbc.Nav(
                [
                    dbc.NavItem(
                        dbc.NavLink("Home", href="/assas_app/home", active="exact")
                    ),
                    dbc.NavItem(
                        dbc.NavLink(
                            "Database", href="/assas_app/database", active="exact"
                        )
                    ),
                    dbc.NavItem(
                        dbc.NavLink("About", href="/assas_app/about", active="exact")
                    ),
                    # dbc.DropdownMenu(
                    #   nav=True,
                    #   in_navbar=True,
...
def init_dashboard(server: object) -> object:
    ...
    dash_app.layout = html.Div(
        [navbar, html.Hr(), dash.page_container], id="dash-container"
    )
