...
def layout() -> html.Div:
    ...
    return_div = html.Div(
        [
            html.H1("Documentation", style={"fontFamily": "Arial, sans-serif"}),
            html.Hr(),
            # Data Access Section
            html.Div(
                [
                    ...
                    html.P(
                        [
                            "The ASSAS Data Hub provides multiple access methods for "
                            "retrieving ASTEC simulation data:"
                        ],
                    ...
                    html.P(
                        [
                            "Users can browse and download datasets directly through "
                            "the web interface. The system provides:"
                        ],
                        style={"fontFamily": "Arial, sans-serif", "lineHeight": "1.6"},
                    ),
                    html.Ul(
                        [
                            html.Li(
                                "Search and filter capabilities by simulation "
                                "parameters",
                    ...
                    html.P(
                        [
                            "For programmatic access, datasets are available through "
                            "the NetCDF4 API, enabling direct integration "
                ...
                [
                    ...
                    html.Pre(
                        [
                            ...
                            "# Open ASTEC dataset\n"
                            "dataset = nc.Dataset('path/to/astec_dataset.nc', 'r')\n\n"
                    ...
                    html.Pre(
                        [
                            ...
                            "th_data = {\n"
                            "   'pressure': dataset.variables['pressure'][time_mask],\n"
                            "   'level': dataset.variables['level'][time_mask],\n"
                            "   'flow_rate': "
                            "dataset.variables['flow_rate'][time_mask]\n"
                            "}\n\n"
                            "# Access 3D spatial data\n"
                            "if 'cont_temp_3d' in dataset.variables:\n"
                            "   temp_3d = dataset.variables['cont_temp_3d'][:]\n"
                            "   # Shape: (time, x, y, z)\n"
                    ...
                    html.Pre(
                        [
                            "def explore_netcdf_dataset(filename):\n"
                            '    """Utility function to explore NetCDF datasets"""\n'
                            "    with nc.Dataset(filename, 'r') as ds:\n"
                            "        print(f'Dataset: {filename}')\n"
                            "        print(f'Dimensions: "
                            "{list(ds.dimensions.keys())}')\n"
            ...
            html.Div(
                [
                    ...
                    html.P(
                        [
                            "ASTEC datasets are stored in NetCDF4 format with "
                            "HDF5 backend, providing:"
                        ],
                        style={"fontFamily": "Arial, sans-serif", "lineHeight": "1.6"},
                    ),
                    html.Ul(
