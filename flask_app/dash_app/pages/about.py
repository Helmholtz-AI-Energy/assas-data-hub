...
def layout() -> html.Div:
    ...
    return_div = \
        ...
        html.P(
        [
        "The ASSAS Data Hub is a comprehensive data management platform for "
        "ASTEC (Accident Source Term Evaluation Code) simulation datasets. "
        "This Flask-based web application provides researchers and engineers "
        "with easy access to nuclear safety "
        "simulation data stored on the Large Scale Data Facility (LSDF) at KIT."
        ],
        ...
        html.P(
        [
        "The Large Scale Data Facility (LSDF) at Karlsruhe Institute of Technology "
        "(KIT) serves as the primary storage infrastructure for ASTEC simulation "
        "datasets. The LSDF provides:"
        ],
        style={"fontFamily": "Arial, sans-serif", "lineHeight": "1.6"},
        ),
        html.Ul(
        ...
        html.P(
        [
        "ASTEC datasets are organized in a hierarchical directory structure on the "
        "LSDF, categorized by simulation type, reactor model, and accident scenario. "
        "Each dataset includes comprehensive metadata describing the simulation "
        ...
        html.P(
        [
        "The ASSAS Data Hub provides multiple access methods for retrieving "
        "ASTEC simulation data:"
        ],
        style={"fontFamily": "Arial, sans-serif", "lineHeight": "1.6"},
        ),
        html.H5(
        ...
        html.P(
        [
        "Users can browse and download datasets directly through the web interface. "
        "The system provides:"
        ],
        style={"fontFamily": "Arial, sans-serif", "lineHeight": "1.6"},
        ),
        ...
        html.P(
        [
        "For programmatic access, datasets are available through the NetCDF4 API, "
        "enabling direct integration with scientific computing workflows:"
        ],
        style={"fontFamily": "Arial, sans-serif", "lineHeight": "1.6"},
        ),
        ],
        ...
        html.P(
        [
        "The ASSAS Data Hub employs a modern web architecture connecting users to "
        "high-performance storage systems. The Flask application interfaces with "
        "MongoDB for metadata management and provides direct access to datasets "
        ...
        html.P(
        [
        "The data flow diagram illustrates how ASTEC simulation results are processed, "
        "stored, and made available through the web interface. The system handles data "
